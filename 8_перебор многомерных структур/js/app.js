...
Как вы видите, не смотря на то, что данная конструкция массивов-объектов двухмерная, для вывода юзеров мы используем один цикл, просто обращаясь внутри этого цикла к различным данным юзера. */
